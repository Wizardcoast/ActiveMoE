...
def _dumps_Llama_MoeConfig(megatron_args):
    ...
    config = LlamaMoeConfig(
        ...
        moe_share_expert_intermediate_size=megatron_args.moe_share_expert_ffn_hidden_size,
        moe_expert_intermediate_size=megatron_args.moe_expert_ffn_hidden_size,
