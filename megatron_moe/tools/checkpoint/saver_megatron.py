...
def save_checkpoint(queue, args):
    ...
    if md.model_type == 'LLaMA':
        sys.argv.extend(['--normalization', 'RMSNorm'])
    ...
    for pp_rank in range(args.target_pipeline_parallel_size):
        ...
        for tp_rank in range(args.target_tensor_parallel_size):
            ...
            if md.iteration == 0:  # iteration=0 is not allowed in checkpoint loading
                md.iteration += 1
