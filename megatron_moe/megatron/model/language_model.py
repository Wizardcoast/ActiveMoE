...
def get_language_model(config, num_tokentypes, add_pooler,
    ...
    assert config.init_method,"init_method should be set in core transformer config"
    assert config.output_layer_init_method,"output_layer_init_method should be set in core transformer config"
...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(self,
        ...
        if self.use_rotary_position_embeddings:
            ...
            self.emb_matrix = self.rotary_pos_emb(self.seq_length)
    ...
    def forward(self, enc_input_ids, enc_position_ids, enc_attn_mask,
        ...
        if self.use_rotary_position_embeddings:
            if inference_params is not None:
                ...
                rotary_pos_emb = self.emb_matrix
