...
class TransformerConfig(ModelParallelConfig):
    """Configuration object for megatron-core transformers.
        ...
        # mixed-precision
        apply_query_key_layer_scaling (bool): If true, scale Q * K^T by 1 / layer-number. Defaults to False.
    ...
    def __post_init__(self):
        ...
        if self.num_query_groups and self.num_query_groups % self.tensor_model_parallel_size != 0:
            raise ValueError(
        ...
        if self.output_layer_init_method is None :
            if self.disable_scaled_init_method:
