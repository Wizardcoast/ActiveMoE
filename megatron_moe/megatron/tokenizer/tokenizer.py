...
class _AutoTokenizer(AbstractTokenizer):
    ...
    def __init__(self, tokenizer_name_or_path, vocab_extra_ids):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name_or_path, **hf_tokenizer_kwargs,trust_remote_code=True)
    ...
    def tokenize_as_chunk(self, text, seq_length):
        return self.tokenizer.encode(text, max_length=seq_length, padding='max_length', truncation=True)
    ...
    def pad_token_id(self):
        if self.tokenizer.pad_token_id is None:
            raise NotImplementedError("Missing <pad>. For HF tokenizer, should use pad")
        return self.tokenizer.pad_token_id