...
OUTPUT_BASEPATH="${MEGATRON_PATH}/save_moe"  # 设置checkpoint/tensorboard的保存路径
LOAD_BASEPATH="${MEGATRON_PATH}/save"
...
LOAD_PRETRAIN_CHECKPOINT_PATH="${LOAD_BASEPATH}/checkpoint/${NAME}"
...
megatron_options="  \
        ...
        --load ${LOAD_PRETRAIN_CHECKPOINT_PATH} \
        --dense2moe \
        --split 100,0,0 \
