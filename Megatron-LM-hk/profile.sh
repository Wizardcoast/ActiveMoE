...
CHECKPOINT_PATH="${OUTPUT_HOME}/checkpoint/profile"
# CHECKPOINT_PATH=/workspace/megatron/checkpoints/save
WANDB_PATH="${OUTPUT_HOME}/"

DATA_PATH=/workspace/megatron/full-gpt2-8node_text_document
DATA_CACHE_PATH=/workspace/megatron/full-gpt2-8node_text_document
...
python3 report_theoretical_memory.py \
    $HKG_MODELING_ARGS \
    $HKG_HYPER_PARAM_ARGS \
    $HKG_TRAINING_ARGS \
    $HKG_DATA_ARGS \
