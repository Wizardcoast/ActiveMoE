...
DATA_PATH=/workspace/megatron/full-amber-8node_token_ids_document
DATA_CACHE_PATH=/workspace/megatron/full-amber-8node_token_ids_document
TOKENIZER_MODEL_PATH="/workspace/megatron/amber.tokenizer.model"
