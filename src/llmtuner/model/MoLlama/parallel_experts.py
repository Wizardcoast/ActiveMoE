...
class ParallelExperts(nn.Module):
    def __init__(self, num_experts, input_size, output_size, bias=False, no_random_init=False) -> None:
        """
        ...
        # )
        self.weight = nn.Parameter(torch.zeros(num_experts, input_size, output_size))
        if bias:
        ...
        if not no_random_init:
            ...
            Warning("init experts from empty! need to process later!")
